...
D=struct('Coord',Coord','Con',Con','Re',Re','LoadCase1',LoadCase1','LoadCase2',LoadCase2', ...
    'E',E','A',A','AV',AV','TM',TM','DM',DM','RO',RO','Group',Group,'LB',LB,'UB',UB,'DMControlNodes' ...
    ,DMControlNodes);
